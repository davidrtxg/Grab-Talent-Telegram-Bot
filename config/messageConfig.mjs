export const MESSAGES = {
    ...
    "success": "Your resume has been successfully received and forwarded to our team at Grab Talent! 🎉\r\nThank you for using our service. We're excited to help you on your career journey!",
